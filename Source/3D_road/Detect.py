...
small_pcd = o3d.io.read_point_cloud("Source/3D_road/merged_cloud_v5_1.ply")
large_pcd = o3d.io.read_point_cloud("Source/3D_road/Testing.ply")

small_pcd = nm.rotateX(small_pcd, -np.pi/12)
# small_pcd = nm.rotateZ(small_pcd, -np.pi/3)
...
large_pcd.paint_uniform_color([1, 0, 0.5])
...
# o3d.io.write_point_cloud("./merged_cloud_v4_3.ply", small_pcd)
...
# cor_Safe = o3d.geometry.TriangleMesh.create_coordinate_frame(size=10)
# cor_Safe.translate(small_pcd.points[12140])
